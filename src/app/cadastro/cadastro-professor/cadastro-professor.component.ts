...
import { ValidaFormService } from './../../aluno/valida-form.service';
...
export class CadastroProfessorComponent implements OnInit {
  ...
  constructor(
    ...
    private validaForm: ValidaFormService
  ) { }
  ...
  ngOnInit() {
    this.professor.senha_professor = '';
  ...
  validaSenha() {
    ...
    if (this.professor.senha_professor == this.confirma_senha) {
